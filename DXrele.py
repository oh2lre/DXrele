...
MCALL = "xx1yy" # <-- add here your own call, create and activate a new user account for it on http://www.geonames.org/login
MNICK = "xx1yy" # <-- add here your own nick, not bot nick, but your own nick, and you will get "log" info (in private) about requests to the bot.
APIKEY = "599" # <-- add here your own aprs.fi api key, get it from: http://aprs.fi/page/api
HOST = "irc.isp.yy" # <-- add here your irc server address
PORT = 6667 # <-- add here your irc server port address
VERSIO = "03.02.2014"
NICK = "myBot" # <-- set your bot nick
IDENT = "myBot" # <-- set same as your bot nick
REALNAME = "DXrele coded by oh2lre. #ohdxhf @ IRCnet :)" # <-- you can tailor the name as you like
CHAN = "#myBotChannel" # <-- set your specific irc channel
readbuffer = ""
